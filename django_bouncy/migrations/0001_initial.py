...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'django_bouncy_bounce', (
            ...
            ('sns_topic', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
    ...
    models = {
        u'django_bouncy.bounce': {
            ...
            'sns_topic': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
